...
import classes from "./ChackList.module.css"
...
const ChackList = ({ openAccodian }) => {
    ...
    const handleNavigate = (event, Subid) => {
        ...
        navigate(`/workspace/${id}/Checklists/${Subid}`);
    }
    ...
    return (
        <>
            ...
            <Stack className={classes.inputContainer}>
                <CreateInput placeHolder={"Create New CheackList"} onSubmit={onSubmit}/>
            </Stack>
        </>
    )
}

export default ChackList
