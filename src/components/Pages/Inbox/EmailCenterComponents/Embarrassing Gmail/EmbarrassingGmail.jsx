...
const EmbarrassingGmail = ({handleClose}) => {
    return (
        <>
                    ...
                    <Card className={classes.boxIn}>
                        ...
                        <CardActions className={classes.signSection}>
                            ...
                            <Typography className={classes.info}>
                                Your intelligent connection to Google Gmail failed. Please press
                                connect and try to connect your account again. Need help? Submit
                                a ticket below.
                            </Typography>
